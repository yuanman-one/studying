...
public class GetByIdElementGenerator extends SelectByPrimaryKeyElementGenerator {
    public GetByIdElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "getById"));
